...
A captured historical controlled-execution proof lives in
`examples/controlled-execution-proof-2026-09-17/`. After expiry, signatures
and digests remain inspectable; live adapter replay of that authorization
